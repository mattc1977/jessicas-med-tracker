  ...
  return (
    <div className="about-page-container">
      ...
      <div className="about-section">
        ...
        <p>
          This is a private, non-commercial application designed and built to assist with the post-surgery recovery of a single individual, Jessica. Its sole purpose is to send critical, time-sensitive alerts, reminders, and logs to support recovery and ensure medication adherence.
        </p>
      </div>
      ...
      <div className="about-section">
        ...
        <p>
          <strong>Terms:</strong> This application is a private tool intended for personal, non-commercial use by its designated users. It is provided as-is, without warranty.
        </p>
        <p>
          <strong>Privacy:</strong> Phone numbers associated with this application are used exclusively for sending the alerts described above. All data is provided with direct consent from the users and is never shared with third parties.
        </p>
      </div>
    </div>
  );
...
export default AboutPage;import './AboutPage.css';
