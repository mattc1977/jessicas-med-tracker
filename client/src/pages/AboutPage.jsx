  ...
  return (
    <div className="about-page-container">
      ...
      <div className="about-section">
        ...
        <p>
          This is a private, non-commercial application designed and built to assist with the post-surgery recovery of a single individual, Jessica. Its sole purpose is to send critical, time-sensitive alerts, reminders, and logs to help ensure medication adherence and recovery milestones are not missed.
        </p>
      </div>
